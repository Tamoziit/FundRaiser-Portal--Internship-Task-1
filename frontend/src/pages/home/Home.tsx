    ...
    <div className="w-full min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="-mt-6 md:-mt-4 w-full flex flex-col items-center justify-center p-6">
        <div className="w-full flex flex-col items-center justify-center mb-6">
          <h1 className="text-[39px] lg:text-[50px] font-bold gradient-text-2 z-10">Profile</h1>
          <span className="lg:text-lg font-medium italic text-gray-100">Your Profile Details</span>
        </div>
