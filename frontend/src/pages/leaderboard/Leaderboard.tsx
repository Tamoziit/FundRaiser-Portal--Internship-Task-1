...
const Leaderboard = () => {
  ...
  return (
    <div>
      ...
      <div className="pt-22 flex flex-col w-full items-center justify-center pb-6">
        {loading ? (
                  ...
                  leaderBoardData?.users?.map((leader, _idx) => (
                    <div key={_idx} className="flex items-center justify-between glassmorphic-3 py-4 px-4 md:px-8 w-full">
                      <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-lg font-semibold text-gray-200">{leader.name}</h1>
                      </div>

                      <div className="flex flex-col items-end">
                        <span className="text-lg font-semibold text-gray-200">{leader.level}</span>
                        <span className="text-base text-gray-800 font-semibold">{leader.raisedAmount}</span>
                        ...
                        <span className="text-base text-gray-800 font-semibold cursor-pointer"
