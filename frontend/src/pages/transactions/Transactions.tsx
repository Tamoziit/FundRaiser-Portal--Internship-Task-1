...
const Transactions = () => {
  ...
  console.log(externalDonations);
  console.log(selfDonations);
          ...
          <>
            <div className="flex flex-col gap-2 items-center justify-center w-full">
              ...
              <div className="flex mt-4 gap-6 items-center justify-center w-full">
                <button className="w-[180px] lg:w-[200px] btn-primary p-2" onClick={() => setCurrState("External")}>External Donations</button>
                <button className="w-[180px] lg:w-[200px] btn-secondary !bg-black/30 hover:!bg-black/40 p-2" onClick={() => setCurrState("Self")}>Self Donations</button>
              </div>
                    ...
                    externalDonations.map((donation, _idx) => (
                      <div key={_idx} className="flex flex-col md:flex-row gap-2 justify-between w-full glassmorphic-2 py-4 px-6">
                        <div className="w-full md:w-1/3">
                          ...
                          <div>
                            <span className="font-medium text-gray-800">Mobile No.:&nbsp;</span>
                        ...
                        <div className="w-full md:w-1/3">
                          ...
                          <div>
                            <span className="font-medium text-gray-800">Reference Code:&nbsp;</span>
                            <span className="break-words font-medium">{donation.code}</span>
                          </div>
                        </div>

                        <div className="w-full md:hidden h-[1.5px] bg-gray-800" />
